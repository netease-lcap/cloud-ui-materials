...
function genTemplate(nameGroup: Record<string, string>) {
  return `<ElFlex
    ...
    alignment="center"
    gutter={0}
    style="font-size:14px; --custom-start: auto; line-height: 1.6;">
    <ElFlex
      direction="horizontal"
      mode="flex"
      justify="start"
      ...
      wrap={false}
      style="width:20%;">
      <ElText text="发起人：" style="color:#999999;min-width:56px;"></ElText>
      <ElText
        style="color:#333333;"
    ...
    <ElFlex
      ...
      <ElText text="发起时间：" style="color:#999999;min-width:70px;"></ElText>
      <ElText
        style="color:#333333;"
        text={(function match(_value) {
          if (_value === true) {
    ...
    <ElFlex
      ...
      wrap={false}
      style="width:20%;padding-left:10px;">
      <ElText text="当前状态：" style="color:#999999;min-width:70px;"></ElText>
      <ElText
        style="border-top-left-radius:4px;border-bottom-left-radius:4px;border-top-right-radius:4px;border-bottom-right-radius:4px; --custom-start: auto; max-width:calc(100% - 70px); padding: 0 8px;"
        text={(function match(_value) {
          if (_value === true) {
    ...
    <ElFlex
      ...
      wrap={false}
      style="width:20%;padding-left:10px;">
      <ElText text="当前节点：" style="color:#999999;min-width:70px;"></ElText>
      <ElText
        style="color:#333333;"
        text={(function match(_value) {
          if (_value === true) {
    ...
    <ElFlex
      ...
      wrap={false}
      style="width:20%;padding-left:10px;">
      <ElText text="参与人：" style="color:#999999;min-width:56px;"></ElText>
      <ElText
        style="color:#333333;"
        text={(function match(_value) {
          if (_value === true) {
