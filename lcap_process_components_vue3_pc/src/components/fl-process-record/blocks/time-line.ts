    ...
    <ElListComponents
      ...
      slotDefault={(current) => <ElFlex direction="horizontal" mode="block">
        <ElFlex
          ...
          <ElFlex
            _if={(current.item.nodeOperation != 'revert') && (current.item.nodeOperation != 'reject') && (current.item.nodeOperation != 'approve') && (current.item.nodeOperation != 'submit') && (current.item.nodeOperation != 'launch') && (current.item.nodeOperation != 'end')}
            direction="horizontal"
            mode="block"
            heightStretch="false"
            widthStretch="false"
          ...
          <ElFlex
            _if={(current.item.nodeOperation == 'approve') || (current.item.nodeOperation == 'submit') || (current.item.nodeOperation == 'launch') || (current.item.nodeOperation == 'end')}
            direction="horizontal"
            widthStretch="false"
            heightStretch="false"
            mode="flex"
