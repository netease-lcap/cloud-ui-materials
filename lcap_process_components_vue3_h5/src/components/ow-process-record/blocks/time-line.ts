          ...
          <VanIcon
            name={(function match(_value) {
              if (_value === true) {
                ...
                })((current.item.nodeOperation == 'approve') || (current.item.nodeOperation == 'submit') || (current.item.nodeOperation == 'launch') || (current.item.nodeOperation == 'end'))
              } else {
              }
            })(current.item.nodeOperation != 'revert' && current.item.nodeOperation != 'reject' && current.item.nodeOperation != 'approve' && current.item.nodeOperation != 'launch' && current.item.nodeOperation != 'submit' && current.item.nodeOperation != 'end')}
