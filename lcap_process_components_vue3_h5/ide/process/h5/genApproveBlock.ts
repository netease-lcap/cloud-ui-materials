 ...
 * @return {*}
 */
export function genH5ApproveBlock(entity: naslTypes.Entity, parentElement: naslTypes.ViewElement, process: ProcessV2) {
...
function genCreateFormTemplate(entity: naslTypes.Entity, nameGroup: NameGroup, selectNameGroupMap: Map<string, NameGroup>) {
  ...
  return `<VanFlex direction="horizontal" mode="block">
    <VanTabs style="width: 100%">
      <VanTab slotTitle={
