...
font-size: 3.73333vw;">
        ...
        <VanLinearLayout
          ...
          wrap={true} mode="flex" justify="start" alignment="center" gap="normal" style="--van-space-base:0px;">
...
line-height: 1.2em;"></VanText>
              ...
              style="color:#333333;width:100%;text-align:left;--custom-start: auto; font-size: 100%;line-height: 1.2em;"
                    overflow="ellipsis"
                    text={
                      (function match(_value) {
                        if (_value === true) {
